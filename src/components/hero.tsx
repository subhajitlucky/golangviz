  ...
  return (
    <section className="relative mx-auto flex max-w-6xl flex-col gap-10 px-6 pb-16 pt-12 md:flex-row md:items-center md:pt-20">
      <div className="flex-1 space-y-6">
        <div className="inline-flex items-center gap-2 rounded-full border border-[color:var(--panel-border)] bg-[color:var(--panel)] px-3 py-2 text-xs font-semibold text-[color:var(--foreground)] shadow-sm">
          Visual Go, explained like a story — open source & free
        </div>
        <div className="space-y-3">
          <h1 className="text-4xl font-bold leading-[1.1] text-[color:var(--foreground)] md:text-5xl">
        ...
        <div className="flex flex-col gap-3 sm:flex-row">
          <Link
            href="/playground"
            className="inline-flex items-center justify-center rounded-full bg-[color:var(--accent)] px-6 py-3 text-sm font-semibold text-white !text-white shadow-md transition hover:-translate-y-0.5"
          ...
          <Link
            href="/path"
            className="inline-flex items-center justify-center rounded-full border border-[color:var(--panel-border)] bg-[color:var(--panel)] px-6 py-3 text-sm font-semibold text-[color:var(--foreground)] transition hover:border-[color:var(--accent)]"
        ...
        <div className="flex flex-wrap gap-4 text-xs text-[color:var(--muted)]">
          <div className="flex items-center gap-2 rounded-full border border-[color:var(--panel-border)] bg-[color:var(--panel)] px-3 py-1">
      ...
      <div className="relative flex-1">
        ...
        <div className="relative surface rounded-2xl p-6 shadow-2xl shadow-blue-500/20 backdrop-blur">
          ...
          <div className="mt-6 surface-ghost rounded-xl p-4 text-xs text-[color:var(--foreground)]">
            <div className="font-mono text-[11px] leading-5 text-[color:var(--foreground)]">
              <div>
